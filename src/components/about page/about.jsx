...
import { GrLinkedin, GrGithub, GrTwitter, GrReactjs } from 'react-icons/gr';
import { FaAngellist } from 'react-icons/fa';
import {BsGit} from 'react-icons/bs';
import {TbBrandRedux} from 'react-icons/tb';
import javascript from '../../assets/javascript.svg';
import {DiRuby, DiNodejs, DiPostgresql} from 'react-icons/di';
import {SiRubyonrails, SiNetlify, SiWebpack, SiJest} from 'react-icons/si'
    ...
    <section class="about-section">
      <div class="abt-me" id="About-me">
        ...
        <div>    
           <span>Front End</span>
              <ul className="box">
                <li className="lang-child"><img  src={javascript}  alt="js-icon"/>JavaScript</li>
                <li className="lang-child"><img src={html} alt="html-icon"/>HTML</li>
                <li className="lang-child"><img src={css} alt="css-icon"/>CSS</li>
                <li className="lang-child"><GrReactjs className='p-img'/>React</li>
                <li className="lang-child"><TbBrandRedux className='p-img'/>Redux</li>
            </ul>
            <span>Back End</span>
              <ul className="box">
                <li className="lang-child"><DiRuby className='p-img'/>Ruby</li>
                <li className="lang-child"><SiRubyonrails className='p-img'/>Ruby On Rails</li>
                <li className="lang-child"><DiNodejs className='p-img'/>Nodejs</li>
                <li className="lang-child"><DiPostgresql className='p-img'/>PostgreSQL</li>
            </ul>
            <span>Tools</span>
              <ul className="box">
                <li className="lang-child"><BsGit className='p-img'/>Git</li>
                <li className="lang-child"><SiNetlify className='p-img'/>Netlify</li>
                <li className="lang-child"><SiWebpack className='p-img'/>Webpack</li>
                <li className="lang-child"><SiJest className='p-img'/>Jest</li>
            </ul>
        </div>
      </div>
    </section>
